...
class _New_note_Page extends State<New_note_Page> {
  ...
  Future _saveEntry(DateTime datetime) async {
              ...
              child: Stack(children: [
                 Column(
                  ...
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(left: MediaQuery.of(context).size.width/28), child:
    ...
    return Row( mainAxisAlignment: MainAxisAlignment.end,
      children: [
        ...
        ElevatedButton(onPressed: () async {
          ...
          child: Align( alignment: Alignment.center,
              child: Icon(Icons.save_as_outlined, color: Colors.black, size: 25,)),
          style: ButtonStyle(
            fixedSize: MaterialStateProperty.all<Size>(Size(MediaQuery.of(context).size.height/10, MediaQuery.of(context).size.height/10)),
            shape: MaterialStateProperty.all(
              RoundedRectangleBorder(
